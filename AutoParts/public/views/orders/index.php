    ...
    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between mb-4">
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="text-muted small mb-0">
                        <?= __('orders.page.subtitle'); ?>
                    </p>
                </div>
            </div>
            <div class="small text-muted mt-1">
                <?= __('orders.breadcrumb.section'); ?>
                &middot;
                <span class="fw-semibold">
                    <?= __('orders.breadcrumb.current'); ?>
                </span>
            </div>
        </div>
        ...
        <?php if ($totalOrders > 0): ?>
            ...
            <div class="small text-muted text-md-end">
                ...
                <div>
                    <?= __('orders.stats.total_amount'); ?>
                    <strong><?= number_format($totalAmount, 2, '.', ' '); ?> грн</strong>
                </div>
                <div>
                    <?= __('orders.stats.paid_count'); ?>
                    <strong><?= $paidCount; ?></strong>
                </div>
                <div class="text-muted mt-1">
                    <?= __('orders.stats.last_order'); ?>
    ...
    <?php if (!empty($flash)): ?>
        <div class="alert alert-info alert-dismissible fade show mb-4" role="alert">
            ...
            <button type="button"
                    ...
                    aria-label="<?= __('orders.flash.close'); ?>"></button>
        </div>
    <?php endif; ?>
    ...
    <?php else: ?>
        ...
        <div class="card border-0 shadow-sm rounded-4 mb-3">
                                        ...
                                        <div class="d-flex flex-column flex-md-row justify-content-between gap-3">
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-center mb-1">
                                                    <div class="me-2">
                                                        <span class="badge <?= $badgeClass; ?> d-inline-flex align-items-center gap-1 px-2 py-1 rounded-pill">
                                                            ...
                                                            <span>
                                                                <?= htmlspecialchars(
                                                                    $statusRaw !== '' ? $statusRaw : __('orders.status.not_set'),
                                                                    ENT_QUOTES,
                                                                    'UTF-8'
                                                                ); ?>
                                                            </span>
                                                ...
                                                <div class="d-flex flex-wrap align-items-center small text-muted mb-2">
                                                    <span class="me-3">
                                                        <span class="text-dark fw-semibold">
                                                            <?= __('orders.item.label.order'); ?>
                                                        </span>
                                                        <?= htmlspecialchars($orderLabel, ENT_QUOTES, 'UTF-8'); ?>
                                                    </span>
                                                    <span class="me-3">
                                                        <i class="bi bi-hash me-1"></i>
                                                        <?= __('orders.item.label.id'); ?>
                                                        <?= (int)$order['id']; ?>
                                                    </span>
                                                    <?php if ($itemsCount > 0): ?>
                                                        <span class="me-3">
                                                            ...
                                                            <?= $itemsCount; ?>
                                                            <?= __('orders.item.label.positions'); ?>
                                                        </span>
                                                    <?php endif; ?>
                                                </div>
                                                ...
                                                <?php else: ?>
                                                    <div class="small text-muted mb-1">
                                                        <i class="bi bi-truck me-1"></i>
                                                        <?= __('orders.item.delivery_fallback'); ?>
                                                    </div>
                                                <?php endif; ?>
                                                ...
                                                <?php if ($customerComment !== '' || $managerComment !== ''): ?>
                                                    <div class="mt-2">
                                                        <?php if ($customerComment !== ''): ?>
                                                            <div class="small text-muted">
                                                                <span class="fw-semibold text-dark">
                                                                    <?= __('orders.item.customer_comment'); ?>
                                                                </span>
                                                        ...
                                                        <?php if ($managerComment !== ''): ?>
                                                            <div class="small text-muted mt-1">
                                                                <span class="fw-semibold text-dark">
                                                                    <?= __('orders.item.manager_comment'); ?>
                                                                </span>
            ...
            <div class="card-footer bg-white border-0 small text-muted d-flex flex-column flex-md-row justify-content-between align-items-md-center">
                <span>
                    <?= __('orders.footer.problem_text'); ?>
                    <a href="/support" class="text-decoration-none fw-semibold">
                        <?= __('orders.history.support_link'); ?>
                    </a>.
                </span>
                <span class="mt-2 mt-md-0">
                    <?= __('orders.footer.status_delay'); ?>
                </span>
            </div>
        </div>
