...
class Address extends Model
{
    ...
    {
        // The API defines the address update route as PUT /api/addresses/:id
        // The default Model::update() uses PATCH which is not supported for addresses,
        // so we call ApiClient::put() directly.
