...
// --- 2) GET /api/orders (список замовлень поточного юзера) ---
...
// --- 3) GET /api/admin/orders (список для адмінки через getOrders) ---
// ЦЕЙ РОУТ МАЄ БУТИ В РАУТЕРІ, ЯКИЙ ТИ ПОВІСИШ НА /api/admin/orders
...
// --- 4) GET /api/admin/orders/:id (одне замовлення для адмінки) ---
