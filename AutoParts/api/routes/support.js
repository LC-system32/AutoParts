...
// GET /api/support  – список тікетів поточного користувача
...
// POST /api/support – створити тікет
...
// GET /api/support/:id – один тікет з повідомленнями (для власника)
...
// POST /api/support/:id/messages – відповідь користувача у тікет
